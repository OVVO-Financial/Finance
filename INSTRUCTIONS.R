...
#Step4: Optimize Data & Portfolio Construction
  ...
  Conditioned.port=VN.Lin.opt(Conditioned,degree_LPM = LPM.degree,degree_UPM = UPM.degree,target_LPM=LPM.target,target_UPM=UPM.target);
  ...
  Conditioned.no.vol.port= VN.Lin.opt(Conditioned.no.vol,degree_LPM = LPM.degree,degree_UPM = UPM.degree,target_LPM=LPM.target,target_UPM=UPM.target);
  ...
  UN.Conditioned.port=VN.Lin.opt(Raw,degree_LPM = LPM.degree,degree_UPM = UPM.degree,target_LPM=LPM.target,target_UPM=UPM.target);

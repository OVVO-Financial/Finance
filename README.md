...
- [Mathematical Finance and Derivative Pricing](#mathematical-finance-and-derivative-pricing)
- [Portfolio Construction and Risk Management](#portfolio-construction-and-risk-management)
- [Directional Decomposition and PCA Attribution](#directional-decomposition-and-pca-attribution)
- [Theory, Utility, and Critique](#theory-utility-and-critique)
- [Data and Replication Notes](#data-and-replication-notes)
...
## Directional Decomposition and PCA Attribution
...
- [Companion HTML write-up: "Everyone Has Been Wrong for 280 Years?"](Images/Peters_Gell-Mann_Critique.html) ([HTML preview](https://htmlpreview.github.io/?https://github.com/OVVO-Financial/Finance/blob/main/Images/Peters_Gell-Mann_Critique.html))
...
- [LTCM reference material](Images/LTCM.pdf) — background reading on the Long-Term Capital Management episode.
